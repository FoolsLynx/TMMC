...
{
    public class TMMCChest : ModTile
    {
        public override void SetDefaults()
        {
            ...
            chest = "Chest";
            chestDrop = ItemType<Items.Placeables.Furniture.TMMCChest>();
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            else
            {
                ...
                {
                    player.showItemIcon2 = ItemType<Items.Placeables.Furniture.TMMCChest>();
                    if (Main.tile[left, top].frameX / 36 == 1)
                        player.showItemIcon2 = ItemType<Items.Misc.TMMCChestKey>();
